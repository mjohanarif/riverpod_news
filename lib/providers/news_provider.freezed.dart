...
mixin _$NewsState {
  ...
  bool get isMaxData => throw _privateConstructorUsedError;
...
abstract class $NewsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, bool isMaxData, NewsModel newsModel});
}
    ...
    return _then(_value.copyWith(
      isLoading: null == isLoading
          ...
          : isLoading // ignore: cast_nullable_to_non_nullable
              as bool,
      isMaxData: null == isMaxData
          ? _value.isMaxData
          : isMaxData // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$NewsStateImpl extends _NewsState {
  const _$NewsStateImpl(
      {this.isLoading = true, this.isMaxData = false, required this.newsModel})
      : super._();
  ...
  @override
  String toString() {
    return 'NewsState(isLoading: $isLoading, isMaxData: $isMaxData, newsModel: $newsModel)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isMaxData, isMaxData) ||
                other.isMaxData == isMaxData) &&
            (identical(other.newsModel, newsModel) ||
                other.newsModel == newsModel));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isLoading, isMaxData, newsModel);
